...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    displayLarge: GoogleFonts.poppins(fontSize: 28.0, fontWeight: FontWeight.bold, color: tBlackColor),
    displayMedium: GoogleFonts.poppins(fontSize: 24.0, fontWeight: FontWeight.w700, color: tBlackColor),
    displaySmall: GoogleFonts.poppins(fontSize: 24.0, fontWeight: FontWeight.normal, color: tBlackColor),
    headlineMedium: GoogleFonts.poppins(fontSize: 18.0, fontWeight: FontWeight.w600, color: tBlackColor),
    headlineSmall: GoogleFonts.poppins(fontSize: 18.0, fontWeight: FontWeight.normal, color: tBlackColor),
    titleLarge: GoogleFonts.poppins(fontSize: 14.0, fontWeight: FontWeight.w600, color: tBlackColor),
    titleSmall: GoogleFonts.poppins(fontSize: 12.0, fontWeight: FontWeight.w400, color: tSemiGreyColor),
    bodyLarge: GoogleFonts.poppins(fontSize: 14.0, color: tBlackColor),
    bodyMedium: GoogleFonts.poppins(fontSize: 14.0, color: tBlackColor.withOpacity(0.8)),
  );
