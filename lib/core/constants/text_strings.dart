...
// -- Home Screen - Text
const String tHomeTitle = "Welcome, ";
const String tMyProfile = "My Profile";
const String tMyLink = "My Link";
...
const String tJoinedAt = " 12 October 2023";

 // -- Link Screen

const String tShare = "Share";
const String tNowYouCanShareLink = "Now You can share Your Link";
